    ...
    GovernorUpgradeable
{
    ...
    function _getGovernorVotesStorage()
        private
        pure
        returns (GovernorVotesStorage storage $)
    {
        assembly {
    ...
    function __GovernorVotes_init(
        IERC1155Votes tokenAddress,
        uint256 _tokenId
    ) internal onlyInitializing {
        __GovernorVotes_init_unchained(tokenAddress, _tokenId);
    }
    ...
    function __GovernorVotes_init_unchained(
        ...
        $._token = IERC1155Votes(address(tokenAddress));
        tokenId = _tokenId;
    }
